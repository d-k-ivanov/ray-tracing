...
{
    auto groundMaterial = std::make_shared<Render::Lambertian>(Render::Color3(0.5, 0.5, 0.5));
    m_World.Add(std::make_shared<Objects::Sphere>(Math::Point3(0, -1000, 0), 1000, groundMaterial));
