    ...
    : Scene(aspectRatio, width, samplesPerPixel, maxDepth)
{
    ...
    m_World.Add(std::make_shared<Objects::Quad>(Math::Point3(555, 555, 555), Math::Vector3(-555, 0, 0), Math::Vector3(0, 0, -555), white));
    m_World.Add(std::make_shared<Objects::Quad>(Math::Point3(0, 0, 555), Math::Vector3(555, 0, 0), Math::Vector3(0, 555, 0), white));

    // Lights
    m_World.Add(std::make_shared<Objects::Quad>(Math::Point3(343, 554, 332), Math::Vector3(-130, 0, 0), Math::Vector3(0, 0, -105), light));
