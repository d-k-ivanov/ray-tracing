    ...
    : Scene(aspectRatio, width, samplesPerPixel, maxDepth)
{
    ...
    m_World.Add(std::make_shared<Sphere>(
        Point3(0, 150, 145), 50, std::make_shared<Metal>(Color3(0.8, 0.8, 0.9), 1.0)
    ));
    ...
    m_World.Add(std::make_shared<Translate>(
